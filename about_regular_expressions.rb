...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # MY_ANSWER: When something before or after it doesn't match.
  end
  ...
  #
  # Why?
  # MY_ANSWER: Because they try to match as many characters as they can.
  ...
  # MY_ANSWER: I'm not entirely certain but it seems that in use alternation is better for matching full words or newlines as opposed to characters of words.
